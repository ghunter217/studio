...
const features = [
  {
    ...
    description: 'Our advanced neural networks analyze market data to make highly accurate predictions, giving you an edge.'
  },
  {
    icon: <Bot className="w-10 h-10 text-primary" />,
    title: 'Fully Automated Trading',
    description: 'Set your strategy and let Lumina handle the rest. 24/7 automated trading means you never miss an opportunity.'
  },
  {
    ...
    <section id="features" className="py-20 md:py-32 bg-secondary">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-bold">Why Choose Lumina?</h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Discover the powerful features that make Lumina the ultimate trading bot.
          </p>
        </div>
